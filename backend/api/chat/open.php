...
json_ok([
    ...
    'pinned_ad_id' => isset($conv['pinned_ad_id']) ? (int)$conv['pinned_ad_id'] : null,
    'pinned_text' => isset($conv['pinned_text']) ? (string)$conv['pinned_text'] : null,
    'pinned_image_url' => isset($conv['pinned_image_url']) ? (string)$conv['pinned_image_url'] : null,
    'pinned_at' => isset($conv['pinned_at']) && $conv['pinned_at'] ? date('c', strtotime($conv['pinned_at'])) : null,
